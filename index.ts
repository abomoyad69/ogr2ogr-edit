...
class Ogr2ogr implements PromiseLike<Result> {
  ...
  constructor(input: Input,oppType:string, opts: Options = {}) {
...
export default function ogr2ogr(input: Input,oppType:string, opts?: Options): Ogr2ogr {
  return new Ogr2ogr(input,oppType, opts)
}
